    ...
    <article className="max-w-2xl mx-auto py-16 min-h-screen flex flex-col gap-10 pb-32">
      ...
      <header className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3 text-[10px] font-mono text-neutral-500 uppercase tracking-widest">
          ...
          <span>|</span>
          <time dateTime={project.dates} suppressHydrationWarning>
            {project.dates}
          </time>
          {project.category && (
            <>
      ...
      {/* ── HERO IMAGE ── */}
      {project.image && (
        <div className="relative aspect-video w-full overflow-hidden border border-border/50 bg-neutral-100 dark:bg-neutral-900 rounded-xl">
          <Image
            src={project.image}
            alt={project.title}
            fill
