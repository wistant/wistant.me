...
import data from "./ai-cloud-downloads.json";
...
const CustomLegend = ({ payload, isDark }: { payload: LegendEntry[]; isDark: boolean }) => {
...
export function AICloudChart() {
  ...
  return (
    <div className="relative my-12 lg:-mx-20 overflow-x-auto focus:outline-none">
      <div className="chart-container w-full max-w-4xl mx-auto border border-neutral-300 dark:border-neutral-700 p-3 sm:p-6 focus:outline-none bg-white dark:bg-transparent">
        ...
        <CustomLegend
          ...
          payload={[
            ...
            { value: "ai", color: isDark ? "#d4d4d4" : "#000000" },
      ...
      <p className="text-center mt-4 px-4 font-mono text-xs sm:text-sm text-gray-600 dark:text-gray-400">
        <Link href="https://ai-sdk.dev" className="text-neutral-900 border-b border-neutral-300 hover:border-neutral-900 transition-colors dark:text-neutral-100 dark:border-neutral-700 dark:hover:border-neutral-100">
          AI SDK
        </Link> is now the #2 largest SDK for AI
